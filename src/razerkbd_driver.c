...
static struct razer_report razer_send_payload(
    IOUSBDeviceInterface **dev, struct razer_report *request_report);
 ...
 *
 * When 1 is written (as a character, 0x31) Macro mode will be enabled, if 0 is
 * written (0x30) then game mode will be disabled
 */
ssize_t razer_attr_write_mode_macro(IOUSBDeviceInterface **usb_dev,
                                    const char *buf, int count) {
  unsigned char enabled = (unsigned char)strtol(buf, NULL, 10);
  struct razer_report report =
      razer_chroma_standard_set_led_state(VARSTORE, MACRO_LED, enabled);
 ...
 */
ssize_t razer_attr_write_mode_macro_effect(IOUSBDeviceInterface **usb_dev,
                                           const char *buf, int count) {
  ...
  switch (product) {
    ...
    case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
      report =
          razer_chroma_standard_set_led_effect(NOSTORE, MACRO_LED, enabled);
    ...
    default:
      report =
          razer_chroma_standard_set_led_effect(VARSTORE, MACRO_LED, enabled);
      break;
  }
  razer_send_payload(usb_dev, &report);
 ...
 * Returns a string
 */
ssize_t razer_attr_read_mode_macro_effect(IOUSBDeviceInterface **usb_dev,
                                          char *buf) {
  struct razer_report report =
 ...
 *
 * The brightness oscillates between fully on and fully off generating a pulsing
 * effect
 */
ssize_t razer_attr_write_mode_pulsate(IOUSBDeviceInterface **usb_dev,
                                      const char *buf, int count) {
  struct razer_report report =
      razer_chroma_standard_set_led_effect(VARSTORE, BACKLIGHT_LED, 0x02);
  razer_send_payload(usb_dev, &report);
 ...
 * Returns a string
 */
ssize_t razer_attr_read_mode_pulsate(IOUSBDeviceInterface **usb_dev,
                                     char *buf) {
  struct razer_report report =
 ...
 * Returns a string
 */
ssize_t razer_attr_read_tartarus_profile_led_red(IOUSBDeviceInterface **usb_dev,
                                                 char *buf) {
  struct razer_report report =
 ...
 * Returns a string
 */
ssize_t razer_attr_read_tartarus_profile_led_green(
    IOUSBDeviceInterface **usb_dev, char *buf) {
  struct razer_report report =
      razer_chroma_standard_get_led_state(VARSTORE, GREEN_PROFILE_LED);
  struct razer_report response = razer_send_payload(usb_dev, &report);
 ...
 * Returns a string
 */
ssize_t razer_attr_read_tartarus_profile_led_blue(
    IOUSBDeviceInterface **usb_dev, char *buf) {
  struct razer_report report =
 ...
 * Returns a string
 */
ssize_t razer_attr_read_get_firmware_version(IOUSBDeviceInterface **usb_dev,
                                             char *buf) {
 ...
 */
ssize_t razer_attr_write_mode_none(IOUSBDeviceInterface **usb_dev,
                                   const char *buf, int count) {
  struct razer_report report = {0};
  ...
  switch (product) {
    ...
    case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
      report =
          razer_chroma_extended_matrix_effect_none(VARSTORE, BACKLIGHT_LED);
      break;
    ...
    case USB_DEVICE_ID_RAZER_ANANSI:
      report =
          razer_chroma_standard_set_led_state(VARSTORE, BACKLIGHT_LED, OFF);
      break;
 ...
 *
 * When 1 is written (as a character, 0x31) the wave effect is displayed moving
 * left across the keyboard if 2 is written (0x32) then the wave effect goes
 * right
 *
 * For the extended its 0x00 and 0x01
 */
ssize_t razer_attr_write_mode_wave(IOUSBDeviceInterface **usb_dev,
                                   const char *buf, int count) {
  ...
  switch (product) {
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_ESSENTIAL:
    case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
      report = razer_chroma_extended_matrix_effect_wave(VARSTORE, BACKLIGHT_LED,
                                                        direction);
      break;

    case USB_DEVICE_ID_RAZER_BLACKWIDOW_CHROMA_V2:
      report = razer_chroma_standard_matrix_effect_wave(VARSTORE, BACKLIGHT_LED,
                                                        direction);
      report.transaction_id.id = 0x3F;  // TODO move to a usb_device variable
      break;
 ...
 */
ssize_t razer_attr_write_mode_spectrum(IOUSBDeviceInterface **usb_dev,
                                       const char *buf, int count) {
  struct razer_report report = {0};
  ...
  switch (product) {
    ...
    case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
      report =
          razer_chroma_extended_matrix_effect_spectrum(VARSTORE, BACKLIGHT_LED);
      break;
    ...
    case USB_DEVICE_ID_RAZER_ANANSI:
      ...
      razer_send_payload(usb_dev, &report);
      report = razer_chroma_standard_set_led_effect(VARSTORE, BACKLIGHT_LED,
                                                    LED_SPECTRUM_CYCLING);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_CHROMA_V2:
      report =
          razer_chroma_standard_matrix_effect_spectrum(VARSTORE, BACKLIGHT_LED);
      report.transaction_id.id = 0x3F;  // TODO move to a usb_device variable
      break;
 ...
 *
 * Sets reactive mode when this file is written to. A speed byte and 3 RGB bytes
 * should be written
 */
ssize_t razer_attr_write_mode_reactive(IOUSBDeviceInterface **usb_dev,
                                       const char *buf, int count) {
  struct razer_report report;
    ...
    switch (product) {
      ...
      case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
        report = razer_chroma_extended_matrix_effect_reactive(
            VARSTORE, BACKLIGHT_LED, speed, (struct razer_rgb *)&buf[1]);
        break;
 ...
 */
ssize_t razer_attr_write_mode_static(IOUSBDeviceInterface **usb_dev,
                                     const char *buf, int count) {
  struct razer_report report = {0};
  ...
  switch (product) {
    ...
    case USB_DEVICE_ID_RAZER_DEATHSTALKER_EXPERT:
      report =
          razer_chroma_standard_set_led_effect(VARSTORE, BACKLIGHT_LED, 0x00);
      razer_send_payload(usb_dev, &report);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_STEALTH_EDITION:
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_ULTIMATE_2012:
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_ULTIMATE_2013:  // Doesn't need any
                                                        // parameters as can
                                                        // only do one type of
                                                        // static
    ...
    case USB_DEVICE_ID_RAZER_ANANSI:
      if (count == 3) {
        report =
            razer_chroma_standard_set_led_state(VARSTORE, BACKLIGHT_LED, ON);
        razer_send_payload(usb_dev, &report);
        report = razer_chroma_standard_set_led_effect(VARSTORE, BACKLIGHT_LED,
                                                      LED_STATIC);
        razer_send_payload(usb_dev, &report);
        report = razer_chroma_standard_set_led_rgb(VARSTORE, BACKLIGHT_LED,
 ...
 *
 * Starlight keyboard effect is activated whenever this file is written to (for
 * bw2016)
 *
 * Or if an Ornata
 ...
 * 1 byte, speed
 */
ssize_t razer_attr_write_mode_starlight(IOUSBDeviceInterface **usb_dev,
                                        const char *buf, int count) {
  struct razer_report report = {0};
  ...
  switch (product) {
    case USB_DEVICE_ID_RAZER_ORNATA:
      if (count == 4) {
        report = razer_chroma_extended_matrix_effect_starlight_single(
    ...
    case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
      if (count == 7) {
        report = razer_chroma_extended_matrix_effect_starlight_dual(
            VARSTORE, BACKLIGHT_LED, buf[0], (struct razer_rgb *)&buf[1],
        ...
        report = razer_chroma_extended_matrix_effect_starlight_random(
 ...
 */
ssize_t razer_attr_write_mode_breath(IOUSBDeviceInterface **usb_dev,
                                     const char *buf, int count) {
  struct razer_report report = {0};
  ...
  switch (product) {
    ...
    case USB_DEVICE_ID_RAZER_ORNATA:
      switch (count) {
        ...
        default:
          printf(
              "razerkbd: Breathing only accepts '1' (1byte). RGB (3byte). RGB, "
              "RGB (6byte)");
          break;
      }
      break;
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_CHROMA_V2:
      switch (count) {
        ...
        default:  // "Random" colour mode
          ...
          razer_send_payload(usb_dev, &report);
          break;
          // TODO move default to case 1:. Then default: printk(warning). Also
          // remove pointless buffer
      }
      break;
 ...
 */
ssize_t razer_attr_read_set_logo(IOUSBDeviceInterface **usb_dev, char *buf,
                                 int count) {
  struct razer_report report =
      razer_chroma_standard_get_led_effect(VARSTORE, LOGO_LED);
  ...
  // Blade laptops don't use effect for logo on/off, and mode 2 ("blink") is
 ...
 * Sets the logo lighting state to the ASCII number written to this file.
 */
ssize_t razer_attr_write_set_logo(IOUSBDeviceInterface **usb_dev,
                                  const char *buf, int count) {
  ...
  // Note: This does allow setting of mode 2 ("blink"), but this is an
 ...
 */
ssize_t razer_attr_write_mode_custom(IOUSBDeviceInterface **usb_dev,
                                     const char *buf, int count) {
  struct razer_report report = {0};
 ...
 * Sets the logo lighting state to the ASCII number written to this file.
 */
ssize_t razer_attr_write_set_fn_toggle(IOUSBDeviceInterface **usb_dev,
                                       const char *buf, int count) {
  unsigned char state = (unsigned char)strtol(buf, NULL, 10);
 ...
 */
ssize_t razer_attr_write_set_brightness(IOUSBDeviceInterface **usb_dev,
                                        const char *buf, int count) {
  ...
  switch (product) {
    case USB_DEVICE_ID_RAZER_TARTARUS_V2:
      report = razer_chroma_extended_matrix_brightness(VARSTORE, ZERO_LED,
                                                       brightness);
      report.transaction_id.id = 0x1F;
      break;
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_ESSENTIAL:
    case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
      report = razer_chroma_extended_matrix_brightness(VARSTORE, BACKLIGHT_LED,
                                                       brightness);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_ULTIMATE_2012:
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_ULTIMATE_2013:
      report = razer_chroma_standard_set_led_brightness(VARSTORE, LOGO_LED,
                                                        brightness);
      break;
 ...
 * Returns a string
 */
ssize_t razer_attr_read_set_brightness(IOUSBDeviceInterface **usb_dev,
                                       char *buf) {
  ...
  switch (product) {
    ...
    case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
      report =
          razer_chroma_extended_matrix_get_brightness(VARSTORE, BACKLIGHT_LED);
      break;
    ...
    default:
      if (is_blade_laptop(usb_dev)) {
        ...
        report =
            razer_chroma_standard_get_led_brightness(VARSTORE, BACKLIGHT_LED);
      }
      break;
  }
 ...
 */
ssize_t razer_attr_write_matrix_custom_frame(IOUSBDeviceInterface **usb_dev,
                                             const char *buf, int count) {
  struct razer_report report;
  int offset = 0;
  ...
  while (offset < count) {
    if (offset + 3 > count) {
      printf(
          "razerkbd: Wrong Amount of data provided: Should be ROW_ID, "
    ...
    switch (product) {
      ...
      case USB_DEVICE_ID_RAZER_CYNOSA_CHROMA:
        report = razer_chroma_extended_matrix_set_custom_frame(
            row_id, start_col, stop_col, (unsigned char *)&buf[offset]);
        break;
 ...
 */
static int razer_get_report(IOUSBDeviceInterface **usb_dev,
